...
"6_Poisson_6_NExp_2_1_AL_extinctions.dat" using 7 title 'Average' with lines lw 2 lc rgb 'red', \
"6_Poisson_6_NExp_2_1_AL_extinctions.dat" using 8 title 'Reference' with line lt 'dashed' lw 2 lc rgb 'black'
